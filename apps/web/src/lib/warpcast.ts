...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "GenkiFi is the first gamified social DeFi platform built specifically for emerging markets on Celo blockchain", // 30 characters, no emojis or special characters, short description under app name
      description: "GenkiFi is the first gamified social DeFi platform built specifically for emerging markets on Celo blockchain", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      ...
      ogDescription: "GenkiFi is the first gamified social DeFi platform built specifically for emerging markets on Celo blockchain", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
